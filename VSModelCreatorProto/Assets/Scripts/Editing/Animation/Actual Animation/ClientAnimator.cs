...
namespace VSMC
{
    ...
    public class ClientAnimator : AnimatorBase
    {
        ...
        /// <summary>
        /// This will hopefully stop all animations and remove any lingering data for editing animations.
        /// </summary>
        public void ResetAllAnimationsForVSMC()
        {
            activeAnimCount = 0;
            CurAnims = new RunningAnimation[CurAnims.Length];
