...
namespace VSMC
{
    ...
    public class TaskDeleteElement : IEditTask
    {
        ...
        List<AnimationEntryAndLocation> CalculateAnimationEntries(List<string> elemNames)
        {
            ...
            {
                for (int i = 0; i < ShapeHolder.CurrentLoadedShape.Animations.Length; i++)
                {
                    Animation anim = ShapeHolder.CurrentLoadedShape.Animations[i];
        ...
        public override void DoTask()
        {
            ...
            {
                ShapeHolder.CurrentLoadedShape
            ...
            {
                ShapeHolder.CurrentLoadedShape.RemoveRootShapeElement(elemToDelete);
            }
        }
        ...
        public override void UndoTask()
        {
            ...
            {
                ShapeHolder.CurrentLoadedShape.AddRootShapeElement(elemToDelete);
            }
