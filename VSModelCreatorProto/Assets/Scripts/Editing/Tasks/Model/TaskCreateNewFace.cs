...
{
    /// <summary>
    /// Creates a single face. Taken from CreateNewElement.
    /// </summary>
    public class TaskCreateNewFace : IEditTask
    {
        public int parentUID = -1;
        public ShapeElement createdElement;

        public TaskCreateNewFace(ShapeElement parent)
        {
            /*
             ...
             */
            createdElement = new ShapeElement(1);
