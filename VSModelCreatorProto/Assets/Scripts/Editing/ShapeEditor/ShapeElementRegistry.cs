...
{
    /// <summary>
    /// This is a list of all shape elements that are currently loaded.
    /// The class is responsible for managing an ID system for the elements.
    /// IDs change on shape load and should never be stored between sessions.
    /// </summary>
